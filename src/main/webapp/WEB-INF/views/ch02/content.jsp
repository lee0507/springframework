	...
	<div class="card-body">
		<div class="card m-2">
			...
			<div class="card-body">
				<div class="m-2">
					<a
						href="${pageContext.request.contextPath}/ch02/method?bkind=free&bno=1"
						class="btn btn-info btn-sm">GET방식</a>
				</div>
				<form method="get" action="${pageContext.request.contextPath}/ch02/method">
					bkind: <input type="text" name="bkind" value="free"> <br />
					bno: <input type="text" name="bno" value="1"> <br /> <input
						type="submit" value="GET방식" class="btn btn-info btn-sm">
				</form>
				...
				<form method="post" action="${pageContext.request.contextPath}/ch02/method">
					bkind: <input type="text" name="bkind" value="free"> <br />
					bno: <input type="text" name="bno" value="1"> <br /> <input
						type="submit" value="POST방식" class="btn btn-info btn-sm">
				</form>
			...
			<script>
            function requestGet() {
            	/* location.href = "${pageContext.request.contextPath}/ch02/method?bkind=lee&bno=26"; */
               $.ajax({
                  url:"${pageContext.request.contextPath}/ch02/method",
                  method: "GET",
                  //data: "bkind=lee&bno=57"
                  data: {bkind: "free", bno:17}
               })
               .done((data) => {});
            }
		...
		<div class="card m-2">
			...
			<div class="card-body">
				...
				<form method="POST"
					action="${pageContext.request.contextPath}/ch02/login2">
