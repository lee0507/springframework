...
public class Ch03Controller {
	...
	@GetMapping("/method1")
	public String method1(String param1, String param2, String param3, 
			String param4, String param5, HttpServletRequest request) {
		log.info(param1);
		log.info(param2);
		log.info(param3);
		log.info(param4);
	...
	/*	@RequestMapping("/method1")
		public String method1(@RequestParam("param1") String arg1, int param2, double param3, 
	...
	@PostMapping("/method2")
	public String method2(@RequestParam("param1") String arg1, int param2, double param3, 
			  			  boolean param4, @DateTimeFormat(pattern="yyyy-MM-dd") Date param5) {
		log.info(arg1);
		log.info(param2);
		log.info(param3);
	...
	public String method4(
			...
			@RequestParam(defaultValue="true") boolean param4) {
		log.info(param1);
		log.info(param2);
		log.info(param3);
		log.info(param4);
