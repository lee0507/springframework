...
public class Ch05Controller {
	...
	public String createCookie(HttpServletResponse response) {
		...
		cookie.setHttpOnly(true); // JavaScript에서 못 읽게함(true), JavaScript에서 읽게함(false)
		cookie.setSecure(false); // https: 또는 http: 모두 전송(false)
...
//		String json = "{\"userid\":\"spring\"}";
		...
		jsonObject.put("useremail", "blueskii@naver.com");
