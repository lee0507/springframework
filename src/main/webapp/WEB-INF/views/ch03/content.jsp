...
<div class="card m-2">
   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
            <a class="btn btn-info btn-sm" 
               href="method1?param1=문자열&param2=2&param3=3.14&param4=true&param5=2021-08-27">a 태그 요청</a>
            <hr/>
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
               const param1 = document.form1.param1.value; //이름으로만 접근한 것
               const param2 = document.querySelector("#param2").value;	//아이디로 접근한 것
               const param3 = $("#param3").val();	//jquery에서 아이디가 param3의 value
            ...
            function requestPost() {
               ...
               $.ajax({
                  ...
                  method:"post",
                  data: {
                     param1:param1, //속성이름하고 변수이름하고 같을 때는 하나로 생략이 가능하다.
                     param2, 
                     param3, 
                     param4, 
                     param5
